...
class PostTypes
{
  ...
  */
    public function register_post_type($pt)
    {
        ...
        $labels['add_new_item']       = isset($pt['labels']['add_new_item'])?$pt['labels']['add_new_item']:__( 'Add '.$singular, $translate );
        $labels['add_new']            = isset($pt['labels']['add_new'])?$pt['labels']['add_new']:__( 'Add '.$singular, $translate );
        $labels['edit_item']          = isset($pt['labels']['edit_item'])?$pt['labels']['edit_item']:__( 'Edit '.$singular, $translate );
        $labels['update_item']        = isset($pt['labels']['update_item'])?$pt['labels']['update_item']:__( 'Update '.$singular, $translate );
        $labels['search_items']       = isset($pt['labels']['search_items'])?$pt['labels']['search_items']:__( 'Search '.$singular, $translate );
        $labels['not_found']          = isset($pt['labels']['not_found'])?$pt['labels']['not_found']:__( $singular.' not found', $translate );
        $labels['not_found_in_trash'] = isset($pt['labels']['not_found_in_trash'])?$pt['labels']['not_found_in_trash']:__( $singular.' not found in trash', $translate );
        ...
        $args['supports']               = isset($pt['args']['support'])?$pt['args']['support']:['title', 'editor', 'comments', 'thumbnail'];
